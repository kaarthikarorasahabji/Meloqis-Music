        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                val trackMetadata = "{\"track_metadata\":{\"artist_name\":\"${escapeJson(
                    ...
                    title,
                )}\",${releasePart}\"additional_info\":{\"duration_ms\":$durationMs,\"position_ms\":$positionMs,\"submission_client\":\"Meloqis Music\",\"submission_client_version\":\"0.1.0\"}}}"
                ...
                val request =
                    Request
                        ...
                        .addHeader("User-Agent", "EchoMusic/5.2.82")
                        .build()
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                val trackMetadataSingle = "{\"listened_at\":$listenedAtStart,\"track_metadata\":{\"artist_name\":\"${escapeJson(
                    ...
                    title,
                )}\",${releasePart}\"additional_info\":{\"duration_ms\":$durationMs,\"start_ms\":$startMs,\"end_ms\":$endMs,\"submission_client\":\"Meloqis Music\",\"submission_client_version\":\"0.1.0\"}}}"
