...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/kaarthikarorasahabji/Meloqis-Music/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Meloqis Music Server",
