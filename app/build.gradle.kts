...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "APK_DOWNLOAD", "\"https://pub-7cad9af12a364d3f928f96a083db320f.r2.dev/previews/0.1.14/meloqis-music-0.1.14-release-preview.apk\"")
        ...
        buildConfigField("String", "FEEDBACK_ENDPOINT", "\"https://meloqis-insights.axenora-meloqis.workers.dev/api/feedback\"")
