...
import echo.music.iad1tya.kotlinytmusicscraper.extractor.Extractor
...
import echo.music.iad1tya.kotlinytmusicscraper.models.YouTubeClient
import echo.music.iad1tya.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
import echo.music.iad1tya.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import echo.music.iad1tya.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import echo.music.iad1tya.kotlinytmusicscraper.models.YouTubeLocale
import echo.music.iad1tya.kotlinytmusicscraper.models.body.AccountMenuBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.BrowseBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.CreatePlaylistBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.EditPlaylistBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.FormData
import echo.music.iad1tya.kotlinytmusicscraper.models.body.GetQueueBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.LikeBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.SubscribeBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.NextBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.PlayerBody
import echo.music.iad1tya.kotlinytmusicscraper.models.body.SearchBody
import echo.music.iad1tya.kotlinytmusicscraper.models.response.DownloadProgress
import echo.music.iad1tya.kotlinytmusicscraper.models.response.RemoteConfig
import echo.music.iad1tya.kotlinytmusicscraper.utils.parseCookieString
import echo.music.iad1tya.kotlinytmusicscraper.utils.sha1
import echo.music.iad1tya.ktorext.curl.CurlLogger
import echo.music.iad1tya.ktorext.encoding.brotli
...
//                    },
    ...
    suspend fun checkForFdroidUpdate() =
        httpClient.get("https://f-droid.org/api/v1/packages/echo.music.iad1tya.simpmusic") {
            contentType(ContentType.Application.Json)
        }
